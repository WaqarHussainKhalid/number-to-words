...
class NumberToWord
{
    ...
    public static function number2Word($value): string
    {
    ...
    protected function numberToWords($number): string
    {
        ...
        for ($i = 1; $i <= 9; $i++) {
            ...
            if (($number >= $j) && ($number < $j + 10)) {
                $r = $number - $j;
                return (new self)->numberToWords($j) . ($r > 0 ? (' ' . (new self)->numberToWords($r)) : '');
            }
        }
        ...
        for ($i = 1; $i <= 9; $i++) {
            ...
            if (($number >= $j) && ($number < $j + 100)) {
                $r = $number - $j;
                return (new self)->numberToWords($i) . ' Hundred ' . ($r > 0 ? ('' . (new self)->numberToWords($r)) : '');
            }
        }
        ...
        for ($i = 1; $i <= 9; $i++) {
            ...
            if (($number >= $j) && ($number < $j + 1000)) {
                $r = $number - $j;
                return (new self)->numberToWords($i) . ' Thousand ' . ($r > 0 ? (' ' . (new self)->numberToWords($r)) : '');
            }
        }
        ...
        for ($i = 1; $i <= 9; $i++) {
            ...
            if (($number >= $j) && ($number < $j + 1000000)) {
                $r = $number - $j;
                return (new self)->numberToWords($i) . ' Million ' . ($r > 0 ? (' ' . (new self)->numberToWords($r)) : '');
            }
        }
        ...
        while ($number > 0) {
            ...
            if ($y > 0) { // skip middle-chunk zero
                ...
                $output = (new self)->numberToWords($y) . $t . $output;
            }
            $cnt++;
        }
